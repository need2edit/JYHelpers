...
/// This layout snaps the collection view to its edges and adjusts the velocity of scrolling to feel more natural.
///
/// This works a lot like the App Store's scrilling rows of apps.
open class BetterSnappingLayout: UICollectionViewFlowLayout {
